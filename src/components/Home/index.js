    ...
    return (
			...
			<section>
			  <p className="info">
				...
				<p className="info"><b>Attention!</b></p>
				<p><b>Due to a surge in traffic, 
				we're doing some maintenance. We should be back up around 5PM EST.
				Thank you for understanding!</b></p>
